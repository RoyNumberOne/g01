<h3 style="text-align: center;">訂單詳情</h3>
<?php		
	try	{
		...
		echo "<table>
		<tr><th width='80px'>訂單編號</th><th width='100px'>會員編號</th><th width='100px'>收件人</th><th width='200px'>聯絡電話</th><th width=80px'>訂單狀態</th><th width=110px'>運送方式</th><th width=200px'>收件地址</th></tr>
		<tr><th></th><th width=80px'>付款方式</th><th width=80px'>原始金額</th><th width=50px'>折扣</th><th width=50px'>運費</th><th width=80px'>付款金額</th><th width=110px'>訂單成立時間</th></tr>";
		...
		foreach ( $prodRows as $i => $prodRow){
			...
			<td><a href='../product_info.html?productNo=".$prodRow["商品編號"]."' style='color:#555555;'>".$prodRow["商品編號"]."</a></td>
			<td>".$prodRow["商品名稱"]."</td>
			<td>".$prodRow["難度等級"]."</td>
			<td>".$prodRow["購買數量"]."</td>
			<td>".$prodRow["商品單價"]."</td>
