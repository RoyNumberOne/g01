...
try{
    ...
    $sql="SELECT cp.forum_post_no, cp.comment_poster, cp.comment_innertext, 
    cp.comment_time,m.mem_no, m.mem_id, m.mem_avator, m.mem_badge1, m.mem_badge2, 
    m.mem_badge3, mr.mem_realname_situation, mg.mem_guide_situation
        ...
        where  fp.forum_post_no = '$forum_post_no' and fp.forum_post_situation = 1 and fp.forum_post_category ='公告'
        group by m.mem_no
