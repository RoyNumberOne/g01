...
try{
    ...
    $sql= "SELECT T.tour_hoster, T.tour_no, T.tour_title,T.tour_innertext, T.tour_min_number, T.tour_max_number, T.tour_activitystart, T.tour_activityend, T.tour_passed, T.tour_verify, T.tour_progress, M.mountain_image, M.mountain_area, M.degree_category, M.mountain_name
                from tour T
