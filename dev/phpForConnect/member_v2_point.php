...
try{
    ...
    <div class="bottom_points_info">
        ...
        ?>
        <table>
            <tr><th>發文編號</th><th>發文標題</th><th>發文日期</th><th>獲得點數</th></tr>
            <?php
        ...
        ?>
        <table>
            <tr><th>揪團編號</th><th>揪團標題</th><th>揪團時間</th><th>獲得點數</th></tr>
            <?php
        ...
        ?>
        <table>
            <tr><th>參團編號</th><th>參團標題</th><th>參團時間</th><th>獲得點數</th></tr>
            <?php
        ...
        series : [
            {
                ...
                data:[          // 数据数组，name 为数据项名称，value 为数据项值
                    {value:<?=$memRow["mem_point_forumpost"]?>, name:'發文獲得'},
                    {value:<?=$memRow["mem_point_tourhost"]?>, name:'揪團獲得'},
                    {value:<?=$memRow["mem_point_tourjoin"]?>, name:'參團獲得'},
                ]
            }
        ]
    })
