...
try{
    ...
    //         FROM forum_post f JOIN member m ON (f.forum_post_poster = m.mem_no) 
    //              JOIN comment_post c ON (f.forum_post_no = c.forum_post_no)
    //         WHERE f.forum_post_situation = 1 and f.forum_post_category = '公告'
    //         GROUP BY f.forum_post_no
    //         ORDER BY f.forum_post_no DESC 
    //         limit 3;";
