...
try{
    ...
    if ($_REQUEST['REVIEWcrClass'] == '揪團區') {
        ...
        $sql = "update member set   ban_tour=1 ,
                                    ban_tour_date=date_add(current_timestamp, interval :comment_report_banLong minute ) 
                                    where mem_no=:mem_no;";
        ...
        $sql = "update member set   ban_forum=1 ,
                                    ban_forum_date=date_add(current_timestamp, interval :comment_report_banLong minute ) 
                                    where mem_no=:mem_no;";
