        ...
        <?php 
            ...
            switch($_FILES["guide_image"]["error"]){
                case UPLOAD_ERR_OK:
                    ...
                    $sql = "UPDATE member_guide 
                            set mem_guide_situation = '未審核' ,
                                `guide_no` = '$guide_no' ,
                                `guide_period_start` = '$guide_period_start',
                                `guide_period_end` = DATE_ADD('$guide_period_start', interval 4 year),
                                `guide_image` = '$guide_image',
                                `mem_guide_verify` = current_timestamp
                            where `mem_no` = '$mem_no';";
